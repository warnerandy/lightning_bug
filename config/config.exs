...
config :lightning_bug, LightningBugWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: LightningBugWeb.ErrorHTML, json: LightningBugWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LightningBug.PubSub,
  live_view: [signing_salt: "s2i0gfGj"]
...
config :lightning_bug, LightningBug.Mailer, adapter: Swoosh.Adapters.Local
